...
9. In the popup, enter `example.com` as the capture filter, start capture, reload the example page, and stop capture. Raw secrets and request bodies can remain disabled.
