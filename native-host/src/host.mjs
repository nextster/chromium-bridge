...
function hostInfo() {
  return {
    ...
    pid: process.pid,
    runtimeSource: process.env.CHROMIUM_BRIDGE_ACTIVE_SOURCE || "direct",
    runtimeEntrypoint: process.env.CHROMIUM_BRIDGE_ACTIVE_ENTRYPOINT || null,
    runtimeCheckout: process.env.CHROMIUM_BRIDGE_ACTIVE_CHECKOUT || null,
    startedAt,
    callerOrigin,
    socketPath,
